...
### Variable Cleaning Helper Functions
...
#### `handle_mixed_date` (vector input)
This function is applied to date variables and allows for correct date conversion in R for different date styles -- character, Excel or date formats.
```{r handle_mixed_date}
...
```{r unidentified_to_0, warning = FALSE}
...
```{r remove_strictly_na, warning = FALSE}
